        ...
        if(isNetworkAvailable(getWriteMessageActivity())) {
            ...
            call.enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    writeMessageActivity.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            writeMessageActivity.runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (b == Boolean.FALSE) {
                                        Toast.makeText(writeMessageActivity, R.string.send_message_failed, Toast.LENGTH_LONG).show();
                                    }
                                    else{
                                        Toast.makeText(writeMessageActivity, R.string.send_message_successful, Toast.LENGTH_LONG).show();
                                        ((WriteMessageActivity)writeMessageActivity).sendMessageSuccessful();
                                    }
                                }
                            });
                        }
            ...
            Toast.makeText(writeMessageActivity, R.string.network_unavailable_message, Toast.LENGTH_LONG).show();
        }
    }
